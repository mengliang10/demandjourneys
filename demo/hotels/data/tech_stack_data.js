  ...
  "layers": [
    {
      ...
      "variations": {
        "var_salesforce": {
          "platforms": [
            {
              "name": "Oracle Opera Cloud PMS (or Opera 5.5 on-prem)",
              "vendor": "Oracle Hospitality",
              "role": "Master property management, room inventory, housekeeping status, and guest folios"
            },
            {
              "name": "Sabre SynXis CRS (or Amadeus iHotelier)",
              "vendor": "Sabre Hospitality / Amadeus",
              "role": "Central reservation system, global rate distribution, and ARI switch"
            },
            {
              "name": "SiteMinder Channel Manager",
              "vendor": "SiteMinder",
              "role": "2-way automated OTA inventory and rate synchronization across 450+ channels"
            },
            {
              "name": "IDeaS G3 RMS",
              "vendor": "IDeaS (SAS)",
              "role": "Automated algorithmic pricing, yield management, and overbooking controls"
            },
            {
              "name": "Oracle Simphony POS",
              "vendor": "Oracle Food & Beverage",
              "role": "F&B restaurant, bar, and room service point of sale integrated to guest folio"
            },
            {
              "name": "Assa Abloy Mobile Access",
              "vendor": "Assa Abloy Global Solutions",
              "role": "NFC and BLE mobile digital room key issuance via Apple Wallet / Google Wallet"
            }
          ],
        ...
        "var_no_salesforce": {
          "platforms": [
            {
              "name": "Mews Cloud PMS / Infor HMS",
              "vendor": "Mews / Infor",
              "role": "Modern API-first cloud PMS with automated payments and guest kiosks"
            },
            {
              "name": "D-EDGE CRS & Channel Manager",
              "vendor": "D-EDGE Hospitality Solutions",
              "role": "Central reservation system and direct booking engine"
            },
            {
              "name": "Duetto Dynamic Revenue Strategy",
              "vendor": "Duetto",
              "role": "Open pricing methodology, personalized loyalty rates, and group quote scoring"
            },
            {
              "name": "Toast / Lightspeed POS",
              "vendor": "Toast / Lightspeed",
              "role": "Cloud-native restaurant and bar POS with handheld ordering tablets"
            },
            {
              "name": "Dormakaba BlueSky Mobile Access",
              "vendor": "Dormakaba",
              "role": "Cloud-managed digital room keys and electronic door locks"
            }
          ],
        ...
        "var_best_money_can_buy": {
          "platforms": [
            {
              "name": "Oracle Opera Cloud Premium Sovereign Dedicated",
              "vendor": "Oracle Hospitality",
              "role": "Dedicated enterprise instance with 99.999% SLA and sovereign data residency"
            },
            {
              "name": "Sabre SynXis Enterprise Central Reservation Core",
              "vendor": "Sabre Hospitality",
              "role": "High-throughput CRS processing 500,000 shopping transactions/sec"
            },
            {
              "name": "IDeaS G3 Optix Enterprise Revenue Suite",
              "vendor": "IDeaS (SAS)",
              "role": "Multi-property enterprise portfolio revenue intelligence and continuous dynamic pricing"
            },
            {
              "name": "Agilysys InfoGenesis Enterprise POS",
              "vendor": "Agilysys",
              "role": "Resort-wide point of sale unifying fine dining, spas, golf courses, and casino floors"
            },
            {
              "name": "Assa Abloy VingCard Allure Smart Glass",
              "vendor": "Assa Abloy",
              "role": "Bespoke smart glass touch panels with integrated DND/MUR and Apple Wallet NFC room keys"
            },
            {
              "name": "Lutron Guestroom Energy Management (myRoom)",
              "vendor": "Lutron Electronics",
              "role": "Automated HVAC and lighting setback tied to PMS occupancy status"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Salesforce",
              "role": "Email, SMS, Mobile Push, and WhatsApp guest journey orchestration"
            },
            {
              "name": "Marketing Cloud Personalization (Interaction Studio)",
              "vendor": "Salesforce",
              "role": "Real-time web/app room upgrade offers and dynamic dining recommendations"
            },
            {
              "name": "Salesforce Marketing Cloud Growth / Advanced",
              "vendor": "Salesforce",
              "role": "Autonomous campaign generation via Einstein 1 Platform"
            },
            {
              "name": "Advertising Studio",
              "vendor": "Salesforce",
              "role": "First-party audience sync to Google Hotel Ads, Meta CAPI, and Tripadvisor"
            }
          ],
        ...
        "var_no_salesforce": {
          "platforms": [
            ...
            },
            {
              "name": "Movable Ink",
              "vendor": "Movable Ink",
              "role": "Dynamic visual content rendering (live local weather, room view photography, countdown to check-in)"
            },
            {
              "name": "Koddi Enterprise Metasearch Engine",
              "vendor": "Koddi",
              "role": "Automated programmatic bidding across Google Hotel Ads, Trivago, and Tripadvisor"
            },
            {
              "name": "Branch.io",
              "vendor": "Branch Metrics",
              "role": "Deep linking directly into mobile app room selection and digital key flow"
            }
          ],
        ...
        "var_best_money_can_buy": {
          "platforms": [
            ...
            },
            {
              ...
              "vendor": "Adobe",
              "role": "AI-driven algorithmic dynamic rate and package personalization on Brand.com"
            },
            {
              "name": "Koddi Enterprise AI Metasearch Suite",
              "vendor": "Koddi",
              "role": "Algorithmic bidding across all global metasearch and sponsored OTA placements"
            },
            {
              "name": "LiveRamp Safe Haven Clean Room",
              "vendor": "LiveRamp",
              "role": "Sovereign data clean room for joint airline and credit card partner monetization"
            }
          ],
      ...
      "variations": {
          ...
          "platforms": [
            {
              ...
              "vendor": "Salesforce",
              "role": "Unified guest service desktop, omni-channel request routing, and SLA tracking"
            },
            {
              "name": "Service Cloud Voice (Amazon Connect)",
              "vendor": "Salesforce / AWS",
              "role": "Integrated cloud telephony for Central Reservations (CRO) with real-time transcription"
            },
            {
            ...
            {
              "name": "Agentforce Hospitality Agent",
              "vendor": "Salesforce",
              "role": "Autonomous conversational AI resolving guest inquiries, folio requests, and late checkouts"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Zendesk",
              "role": "Omni-channel ticketing, live chat, and help center for guest service"
            },
            {
              "name": "Genesys Cloud CX",
              "vendor": "Genesys",
              "role": "Global cloud contact center for central reservation offices (CRO)"
            },
            {
              "name": "Akia / Hoperator AI Guest Messaging",
              "vendor": "Akia / Hoperator",
              "role": "Specialized hotel conversational AI platform for contactless check-in and guest text messaging"
            },
            {
              "name": "SevenRooms VIP Guest Experience",
              "vendor": "SevenRooms",
              "role": "Hospitality CRM and reservation platform for restaurant and nightlife VIP management"
            }
          ],
        ...
        "var_best_money_can_buy": {
          "platforms": [
            ...
            {
              "name": "Palantir AIP VIP Host & Casino Executive Desk",
              "vendor": "Palantir Technologies",
              "role": "Dedicated high-roller resolution platform with automated comp authorization and credit line management"
            },
            {
              "name": "Nuance Gatekeeper Voice Biometrics",
              "vendor": "Microsoft / Nuance",
              "role": "Instant voice biometrics authentication in IVR (< 3 seconds) for high-net-worth VIPs"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Salesforce",
              "role": "Hotel reward points ledger, elite tier qualification, and partner rewards catalog"
            },
            {
              "name": "Salesforce Data Cloud for Loyalty",
              "vendor": "Salesforce",
              "role": "Real-time tier status calculation and dynamic room upgrade certificate issuance"
            },
            {
              "name": "Salesforce Experience Cloud Loyalty Portal",
              "vendor": "Salesforce",
              "role": "Member digital self-service, points redemption, and claim missing stay credits"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Antavo",
              "role": "Custom high-throughput ledger supporting 80,000 TPS across global properties"
            },
            {
              "name": "Points.com / Rocketmiles API",
              "vendor": "Points.com / Plusgrade",
              "role": "Global loyalty coalition exchange connecting airline miles and hotel points"
            },
            {
              "name": "Visa Direct & Amex Global Gateway",
              "vendor": "Visa / American Express",
              "role": "Real-time card-linked offer redemption at hotel restaurants, spas, and shops"
            }
          ],
    ...
    },
    {
      ...
      "variations": {
        "var_salesforce": {
          "platforms": [
            {
              "name": "Salesforce Data Cloud for Hospitality",
              "vendor": "Salesforce",
          ...
          "platforms": [
            {
              ...
              "vendor": "Adobe",
              "role": "B2C & B2B unified streaming guest profile with patented identity governance"
            },
            {
              "name": "Snowflake Hospitality Data Clean Room",
              "vendor": "Snowflake",
              "role": "Sovereign multi-party data collaboration with airlines, OTAs, and luxury retailers"
            },
            {
              "name": "Palantir Foundry Dynamic Guest Ontology",
              "vendor": "Palantir Technologies",
              "role": "Deep kinetic graph linking guest relationships, corporate accounts, and property spend"
            }
          ],
      ...
      "variations": {
        "var_salesforce": {
          "platforms": [
            ...
            {
              "name": "MuleSoft Accelerator for Hospitality",
              "vendor": "Salesforce / MuleSoft",
              "role": "Pre-built connectors mapping Oracle OHIP, SynXis CRS, and Simphony POS to Salesforce DMOs"
            },
            {
        ...
        "var_best_money_can_buy": {
          "platforms": [
            ...
            },
            {
              ...
              "vendor": "Solace",
              "role": "Hardware-accelerated ultra-low-latency event mesh for mega-resort IoT and gaming operations"
            },
            {
        ...
        "var_best_money_can_buy": {
          "platforms": [
            ...
            },
            {
              ...
              "vendor": "Snowflake",
              "role": "Isolated zero-trust clean rooms for travel partner and casino gaming data exchange"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Salesforce",
              "role": "Autonomous agent orchestration for hotel guest concierge, room service, and housekeeping dispatch"
            },
            {
              "name": "Claude 3.5 Sonnet / Claude 3.7 via Model Context Protocol (MCP)",
              "vendor": "Anthropic / Salesforce",
              "role": "Frontier multi-modal reasoning connected to hotel operational tools via MCP"
            },
            {
              "name": "Einstein 1 Predictive AI Platform",
              "vendor": "Salesforce",
              "role": "Guest churn scoring, room upgrade propensity modeling, and cancellation probability prediction"
            }
          ],
          "licensing_acv": "$1,250,000 - $2,400,000 / year",
        ...
        "var_no_salesforce": {
          "platforms": [
            ...
            },
            {
              ...
              "role": "Multi-agent autonomous state machines for hotel operations workflows"
            },
            {
              "name": "Pinecone Enterprise Vector Database",
              "vendor": "Pinecone",
              "role": "Sub-50ms vector search for hotel property directories, menus, and local area guides"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Palantir Technologies",
              "role": "Ontology-grounded autonomous agentic operational command for mega-resorts and casino operations"
            },
            {
            ...
            {
              "name": "Custom Hospitality SLMs (Mistral Large On-Premise)",
              "vendor": "Mistral AI / In-House",
              "role": "Locally hosted sovereign 70B parameter models fine-tuned on 15 years of luxury guest service logs"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "role": "High-conversion direct digital room booking, room selection, and payment checkout"
            },
            {
              "name": "Native iOS (Swift) & Android (Kotlin) Mobile Apps",
              "vendor": "In-House",
              "role": "Mobile digital key, live room service tracking, and push notifications"
            },
            {
              "name": "Salesforce Experience Cloud Portals",
              "vendor": "Salesforce",
              "role": "Loyalty member portal, corporate account negotiated rate booking, and travel advisor extranet"
            },
            {
              "name": "Apple Wallet NFC Digital Key Service",
              "vendor": "Apple Inc.",
              "role": "Instant tap-to-unlock hotel room door via iPhone or Apple Watch without opening an app"
            }
          ],
        ...
        "var_no_salesforce": {
          "platforms": [
            ...
            },
            {
              ...
              "vendor": "In-House",
              "role": "Mobile app with offline digital key cache and interactive resort maps"
            },
            {
              "name": "Auth0 by Okta CIAM",
              "vendor": "Okta",
              "role": "Customer Identity and Access Management with passkeys and biometric face login"
            },
            {
              "name": "Zaplox Mobile Key SDK",
              "vendor": "Zaplox",
              "role": "Turnkey mobile key integration for hotel apps"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "role": "100% Swift & Kotlin native codebases with Apple Vision Pro spatial suite walkthroughs"
            },
            {
              "name": "Apple Wallet NFC Room Key with Express Mode",
              "vendor": "Apple Inc.",
              "role": "Tap iPhone/Watch to door lock without waking device; works even if phone battery is depleted"
            },
            {
              "name": "In-Room Crestron / Lutron Luxury Touch Panels",
              "vendor": "Crestron / Lutron",
              "role": "Bespoke in-room automation tablets controlling lighting, shades, temperature, and butler call"
            },
            {
          ...
          "platforms": [
            {
              ...
              "vendor": "Contentful",
              "role": "Structured content repository powering web, mobile, in-room TVs, and digital signage"
            },
            {
              "name": "Cloudinary Enterprise DAM",
              "vendor": "Cloudinary",
              "role": "AI-powered automated room photography and video optimization across all device breakpoints"
            },
            {
              "name": "Salesforce Experience Cloud CMS",
              "vendor": "Salesforce",
              "role": "Integrated portal content management for loyalty members and B2B corporate bookers"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Adobe",
              "role": "The enterprise standard for global multi-brand, multi-property digital experience management"
            },
            {
              "name": "Adobe Dynamic Media with Scene7",
              "vendor": "Adobe",
              "role": "Real-time 3D room rendering and automated smart-cropping for millions of asset variants"
            },
            {
      ...
      "variations": {
        "var_salesforce": {
          "platforms": [
            ...
            {
              "name": "Oracle Opera City Ledger & Night Audit",
              "vendor": "Oracle Hospitality",
              "role": "Daily room revenue posting, guest ledger reconciliation, and tax accrual"
            },
            {
            ...
            },
            {
              ...
              "vendor": "Salesforce",
              "role": "Corporate MICE recurring billing and hotel sustainability / carbon offset accounting"
            }
          ],
          "licensing_acv": "$2,200,000 - $3,800,000 / year",
          ...
          "platforms": [
            {
              ...
              "vendor": "SAP / Oracle",
              "role": "Cloud ERP for multi-entity hotel financial management and consolidation"
            },
            {
            ...
            {
              "name": "Avalara AvaTax for Hospitality",
              "vendor": "Avalara",
              "role": "Automated hotel occupancy tax (TOT), municipal tourism assessments, and VAT calculation"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "SAP",
              "role": "Tier-1 global financial backbone unifying multiple hotel operating companies and asset owners"
            },
            {
              "name": "Kyriba Enterprise Treasury Management",
              "vendor": "Kyriba",
              "role": "Global multi-currency liquidity forecasting, debt covenant monitoring, and FX risk management"
            },
            {
          ...
          "platforms": [
            {
              ...
              "vendor": "Workday",
              "role": "Core HRIS, talent management, benefits, and global hotel staff payroll"
            },
            {
            ...
            {
              "name": "UniFocus / HotSOS (Amadeus)",
              "vendor": "UniFocus / Amadeus",
              "role": "Automated housekeeping room assignment, inspection workflows, and engineering dispatch"
            }
          ],
        ...
        "var_no_salesforce": {
          "platforms": [
            ...
            },
            {
              ...
              "vendor": "UKG",
              "role": "Hotel workforce management, time and attendance, and predictive labor scheduling"
            },
            {
              "name": "Quore Hotel Operations Platform",
              "vendor": "Quore",
              "role": "Housekeeping management, guest request dispatch, and preventive engineering maintenance"
            }
          ],
          ...
          "platforms": [
            {
              ...
              "vendor": "Workday",
              "role": "Global human capital management, predictive labor planning, and executive succession"
            },
            {
              "name": "HotSOS Enterprise Suite (Amadeus)",
              "vendor": "Amadeus Hospitality",
              "role": "Enterprise-wide service optimization, automated preventative maintenance, and asset lifecycle tracking"
            },
            {
              "name": "UKG InTouch DX Biometric Timeclocks",
              "vendor": "UKG",
              "role": "Enterprise facial recognition clock-in for 15,000+ hotel staff and banqueting crews"
            },
            {
              "name": "CyberArk Employee Identity Protection",
              "vendor": "CyberArk",
              "role": "Zero-trust privileged identity access for hotel property managers and night auditors"
            }
          ],
        ...
        "var_best_money_can_buy": {
          "platforms": [
            ...
            },
            {
              ...
              "vendor": "BigID",
              "role": "AI-driven discovery of dark, unstructured sensitive guest data across multi-cloud lakes"
            }
          ],
