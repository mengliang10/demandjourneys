#!/usr/bin/env python3
"""
Cruises & Maritime Enterprise Tech Stack Generator
Generates:
1. /run/media/ml/Storage/Labs/cruises/data/tech_stack_data.json
2. /run/media/ml/Storage/Labs/cruises/data/tech_stack_data.js
3. /run/media/ml/Storage/Labs/cruises/tech_stack.html
4. /run/media/ml/Storage/Labs/cruises/ENTERPRISE_TECH_STACK_ARCHITECTURE_COMPENDIUM.md
"""
...
CRUISE_DIR = os.path.join(BASE_DIR, "cruises")
    ...
    "layers": [
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Oracle Fidelio Cruise PMS", "vendor": "Oracle Hospitality", "role": "Onboard property management, stateroom inventory, passenger embarkation, and cashless guest folios"},
                        {"name": "Versonix Seaware CRS", "vendor": "Versonix", "role": "Central reservation system, cabin inventory management, dynamic pricing, and travel advisor extranet"},
                        {"name": "Agilysys InfoGenesis POS", "vendor": "Agilysys", "role": "Shipboard restaurant, bar, spa, retail, and casino cashless point of sale"},
                        {"name": "Rescompany ShoreEx", "vendor": "Rescompany Systems", "role": "Shore excursion booking, tour capacity management, and local port operator dispatch"},
                        {"name": "Assa Abloy Marine RFID Door Locks", "vendor": "Assa Abloy Global Solutions", "role": "Heavy-duty maritime RFID stateroom locks and electronic muster station scanners"},
                        {"name": "Starlink Maritime Edge Cache", "vendor": "SpaceX / In-House", "role": "On-ship edge server caching and queuing transactions during satellite blackouts"}
                    ],
                ...
                "var_no_salesforce": {
                    "platforms": [
                        {"name": "Rescompany PMS & CRS", "vendor": "Rescompany Systems", "role": "Integrated shipboard PMS, central reservations, and shore excursion management"},
                        {"name": "SilverWhere Table Management", "vendor": "SilverWhere", "role": "Shipboard specialty dining reservations and table seating optimization"},
                        {"name": "MXP Marine Operations Platform", "vendor": "MarineXchange (MXP)", "role": "Shipboard hotel, food & beverage provisioning, and technical maintenance"},
                        {"name": "Dormakaba Saflok RFID Marine Locks", "vendor": "Dormakaba", "role": "Salt-spray resistant electronic stateroom door locks and crew access keys"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "Carnival OceanMedallion IoT Wearable Ecosystem", "vendor": "Carnival Corporation / Bespoke", "role": "Autonomous wearable IoT disc delivering walk-up stateroom unlocking, guest location tracking, and drink delivery anywhere on ship"},
                        {"name": "Versonix Seaware Enterprise Private Cloud", "vendor": "Versonix", "role": "Dedicated high-throughput reservation engine processing multi-ship portfolio bookings"},
                        {"name": "Oracle Fidelio Cruise Enterprise Sovereign", "vendor": "Oracle Hospitality", "role": "Dedicated enterprise PMS with biometric passenger embarkation"},
                        {"name": "Starlink Maritime Dual LEO + SES O3b mPOWER GEO", "vendor": "SpaceX / SES Satellites", "role": "Multi-gigabit redundant satellite communication delivering 500Mbps+ per vessel at sea"},
                        {"name": "Transas Marine Navi-Sailor ECDIS & VMS", "vendor": "Wärtsilä Marine", "role": "Electronic chart display, navigation safety, and vessel traffic monitoring"}
                    ],
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Salesforce Marketing Cloud Engagement", "vendor": "Salesforce", "role": "Email, SMS, Mobile Push, and WhatsApp pre-cruise journey orchestration"},
                        {"name": "Marketing Cloud Personalization (Interaction Studio)", "vendor": "Salesforce", "role": "Real-time web/app shore excursion recommendations and drink package upselling"},
                        ...
                        {"name": "Advertising Studio", "vendor": "Salesforce", "role": "First-party audience sync to Meta CAPI, Google Ads, and cruise travel consortia"}
                    ],
                ...
                "var_no_salesforce": {
                    "platforms": [
                        ...
                        {"name": "Movable Ink", "vendor": "Movable Ink", "role": "Dynamic visual content rendering (live port countdowns, stateroom view photos in email)"},
                        {"name": "Branch.io", "vendor": "Branch Metrics", "role": "Deep linking directly into mobile app check-in and digital muster drill"},
                        {"name": "AppsFlyer Enterprise", "vendor": "AppsFlyer", "role": "Mobile app attribution, marketing analytics, and travel agent referral tracking"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        ...
                        {"name": "Adobe Journey Optimizer (AJO)", "vendor": "Adobe", "role": "Unified omni-channel orchestration across digital, terminal, and shipboard touchpoints"},
                        {"name": "Adobe Target Enterprise", "vendor": "Adobe", "role": "AI-driven algorithmic dynamic package and cabin upgrade personalization"},
                        {"name": "Marketo Measure (Bizible)", "vendor": "Adobe", "role": "Multi-touch travel advisor consortia (Virtuoso, Signature) commission attribution"},
                        {"name": "LiveRamp Safe Haven Clean Room", "vendor": "LiveRamp", "role": "Sovereign data clean room for co-brand bank and airline partner monetization"}
                    ],
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Salesforce Service Cloud Enterprise", "vendor": "Salesforce", "role": "Unified guest and travel advisor service desktop, omni-channel case routing, and SLA tracking"},
                        {"name": "Service Cloud Voice (Amazon Connect)", "vendor": "Salesforce / AWS", "role": "Integrated cloud contact center telephony for vacation planners with real-time transcription"},
                        {"name": "Salesforce Digital Engagement", "vendor": "Salesforce", "role": "WhatsApp, SMS, Apple Messages for Business, and Web Chat routing"},
                        {"name": "Agentforce Cruise Concierge", "vendor": "Salesforce", "role": "Autonomous conversational AI resolving stateroom questions, dining reservations, and shore excursion bookings"}
                    ],
                ...
                "var_no_salesforce": {
                    "platforms": [
                        {"name": "Microsoft Dynamics 365 Customer Service", "vendor": "Microsoft", "role": "Enterprise case management and omni-channel agent desktop for travel advisors"},
                        {"name": "Genesys Cloud CX", "vendor": "Genesys", "role": "Global cloud contact center, intelligent routing and workforce management"},
                        {"name": "Ada CX AI", "vendor": "Ada", "role": "Conversational AI resolution engine for passenger pre-cruise self-service"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        ...
                        {"name": "Palantir AIP VIP High-Roller & Yacht Club Butler Desk", "vendor": "Palantir Technologies", "role": "Dedicated high-net-worth passenger resolution desk with automated casino comps and suite upgrade authority"},
                        {"name": "Nuance Gatekeeper Voice Biometrics", "vendor": "Microsoft / Nuance", "role": "Instant frictionless voice biometrics authentication in IVR (< 3 seconds) for high-roller casino guests"}
                    ],
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Salesforce Loyalty Management", "vendor": "Salesforce", "role": "Cruise loyalty points/cruise-night ledger, elite tier qualification, and onboard benefits engine"},
                        {"name": "Salesforce Data Cloud for Loyalty", "vendor": "Salesforce", "role": "Real-time tier status calculation and dynamic onboard credit (OBC) provisioning"},
                        {"name": "Salesforce Experience Cloud Loyalty Portal", "vendor": "Salesforce", "role": "Member digital self-service, cruise history, and future cruise booking credits"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "Antavo Enterprise Loyalty Cloud Sovereign", "vendor": "Antavo", "role": "Custom high-throughput ledger supporting global fleet-wide real-time point transactions"},
                        {"name": "Points.com / Rocketmiles API", "vendor": "Points.com / Plusgrade", "role": "Global loyalty coalition exchange connecting airline miles and cruise points"},
                        {"name": "Visa Direct & Amex Global Gateway", "vendor": "Visa / American Express", "role": "Real-time card-linked offer redemption at cruise port shops and shipboard boutiques"}
                    ],
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Salesforce Data Cloud for Travel", "vendor": "Salesforce", "role": "Zero-Copy data harmonization, ship-to-shore identity resolution, and real-time Calculated Insights"},
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "Adobe Real-Time Customer Data Platform (RT-CDP)", "vendor": "Adobe", "role": "B2C & B2B unified streaming cruiser profile with patented identity governance"},
                        {"name": "Snowflake Cruise & Travel Data Clean Room", "vendor": "Snowflake", "role": "Sovereign multi-party data collaboration with airlines, port authorities, and luxury retailers"},
                        {"name": "Palantir Foundry Dynamic Passenger Ontology", "vendor": "Palantir Technologies", "role": "Deep kinetic graph linking passenger relationships, travel advisor networks, and onboard spending"}
                    ],
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        ...
                        {"name": "MuleSoft Marine Edge Queue Adapter", "vendor": "Salesforce / MuleSoft", "role": "Asynchronous store-and-forward queue ensuring zero data loss during open-ocean satellite drops"},
                ...
                "var_no_salesforce": {
                    "platforms": [
                        {"name": "Confluent Cloud Enterprise (Kafka) + Onboard Edge Brokers", "vendor": "Confluent", "role": "Managed cloud event streaming with lightweight local Kafka brokers deployed on each ship"},
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        ...
                        {"name": "Solace PubSub+ Event Broker (Ship & Shore)", "vendor": "Solace", "role": "Hardware-accelerated ultra-low-latency event mesh deployed on every vessel and terrestrial data center"},
                        ...
                        {"name": "Starlink Maritime SD-WAN Acceleration", "vendor": "SpaceX / Peplink", "role": "Multi-WAN bonding combining Starlink LEO, O3b GEO, and 5G coastal cellular links"}
                    ],
                    "licensing_acv": "$2,600,000 - $4,500,000 / year",
                    "implementation_capex": "$3,000,000 - $5,200,000",
                    "annual_run_cost": "$1,100,000 / year",
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        ...
                        {"name": "AWS Outposts / Snowball on Ships", "vendor": "Amazon Web Services", "role": "On-premise edge compute running local microservices and databases on each cruise ship"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        ...
                        {"name": "Snowflake Sovereign Clean Rooms", "vendor": "Snowflake", "role": "Isolated zero-trust clean rooms for travel consortia and casino gaming data exchange"}
                    ],
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Salesforce Agentforce & Atlas Reasoning Engine", "vendor": "Salesforce", "role": "Autonomous agent orchestration for shipboard butler service, shore excursion booking, and dining reservations"},
                        {"name": "Claude 3.5 Sonnet / Claude 3.7 via Model Context Protocol (MCP)", "vendor": "Anthropic / Salesforce", "role": "Frontier multi-modal reasoning connected to cruise operational tools via MCP"},
                        {"name": "Einstein 1 Predictive AI Platform", "vendor": "Salesforce", "role": "Onboard spend propensity modeling, cabin upgrade bidding optimization, and cancellation prediction"}
                    ],
                    "licensing_acv": "$1,150,000 - $2,200,000 / year",
                    "implementation_capex": "$950,000 - $1,800,000",
                ...
                "var_no_salesforce": {
                    "platforms": [
                        ...
                        {"name": "LangGraph & CrewAI Frameworks", "vendor": "Open Source / CrewAI", "role": "Multi-agent autonomous state machines for cruise operations workflows"},
                        {"name": "Pinecone Enterprise Vector Database", "vendor": "Pinecone", "role": "Sub-50ms vector search for port guides, excursion descriptions, and daily cruise compass activity schedules"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "Palantir AIP (Artificial Intelligence Platform)", "vendor": "Palantir Technologies", "role": "Ontology-grounded autonomous agentic operational command for fleet navigation, weather re-routing, and casino high-roller management"},
                        ...
                        {"name": "Custom Maritime SLMs (Mistral Large On-Ship)", "vendor": "Mistral AI / In-House", "role": "Locally hosted sovereign 70B parameter models deployed on shipboard edge servers for offline reasoning"}
                    ],
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Custom React / Next.js Web Booking Engine", "vendor": "In-House / Vercel", "role": "High-conversion direct cruise search, deck plan cabin picker, and payment checkout"},
                        {"name": "Native iOS (Swift) & Android (Kotlin) Cruise Apps", "vendor": "In-House", "role": "Shipboard daily activity compass, mobile stateroom key, chat, and dining reservations"},
                        {"name": "Salesforce Experience Cloud Portals", "vendor": "Salesforce", "role": "Travel advisor booking portal, consortia extranet, and past-guest loyalty portal"},
                        {"name": "Interactive Stateroom IPTV Portal", "vendor": "Allin-Interactive / In-House", "role": "In-cabin television app for folio inspection, room service ordering, and shore excursion video previews"}
                    ],
                ...
                "var_no_salesforce": {
                    "platforms": [
                        ...
                        {"name": "Native iOS & Android Mobile Apps", "vendor": "In-House", "role": "Mobile app with offline daily compass cache and peer-to-peer guest messaging"},
                        {"name": "Auth0 by Okta CIAM", "vendor": "Okta", "role": "Customer Identity and Access Management with biometric face login and social login"},
                        {"name": "Zaplox / Dormakaba Mobile Key SDK", "vendor": "Zaplox", "role": "Turnkey mobile key integration for cruise apps"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "Carnival OceanMedallion Wearable Ecosystem", "vendor": "Carnival Corporation / Bespoke", "role": "Wearable IoT disc that unlocks stateroom door automatically upon approach (hands-free), tracks guest location for drink delivery, and handles all purchases"},
                        {"name": "Ultra-High-End Bespoke Native iOS & Android Apps", "vendor": "In-House / Apple Elite Partnership", "role": "100% Swift & Kotlin native codebases with Apple Vision Pro spatial ship and stateroom walkthroughs"},
                        {"name": "In-Stateroom Crestron / Lutron Luxury Touch Panels", "vendor": "Crestron / Lutron", "role": "Bespoke in-room automation tablets controlling lighting, balcony privacy glass, temperature, and butler call"},
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Contentful Enterprise Headless CMS", "vendor": "Contentful", "role": "Structured content repository powering web, mobile, in-cabin TVs, and interactive digital wayfinders"},
                        {"name": "Cloudinary Enterprise DAM", "vendor": "Cloudinary", "role": "AI-powered automated cruise ship photography and deck plan optimization across all device breakpoints"},
                        {"name": "Salesforce Experience Cloud CMS", "vendor": "Salesforce", "role": "Integrated portal content management for past cruisers and travel advisors"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "Adobe Experience Manager (AEM Sites & AEM Assets Enterprise)", "vendor": "Adobe", "role": "The enterprise standard for global multi-brand, multi-region cruise experience management"},
                        {"name": "Adobe Dynamic Media with Scene7", "vendor": "Adobe", "role": "Real-time 3D ship and stateroom rendering and automated smart-cropping for millions of asset variants"},
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        ...
                        {"name": "Oracle Fidelio Cruise Financial Folio Settlement", "vendor": "Oracle Hospitality", "role": "End-of-cruise passenger credit card settlement, cash ledger, and onboard revenue accounting"},
                        ...
                        {"name": "Salesforce Billing & Net Zero Cloud", "vendor": "Salesforce", "role": "Travel agency commission settlement, corporate charter invoicing, and MARPOL carbon emissions accounting"}
                    ],
                ...
                "var_no_salesforce": {
                    "platforms": [
                        {"name": "SAP S/4HANA Public Cloud / Oracle NetSuite", "vendor": "SAP / Oracle", "role": "Cloud ERP for multi-currency maritime financial management and consolidation"},
                        {"name": "Stripe Enterprise Payments", "vendor": "Stripe", "role": "Global payment infrastructure with Stripe Radar fraud detection"},
                        {"name": "Avalara AvaTax for Maritime & Tourism", "vendor": "Avalara", "role": "Automated international port passenger head taxes and VAT calculation"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "SAP S/4HANA Enterprise Private Cloud (with Central Finance)", "vendor": "SAP", "role": "Tier-1 global financial backbone unifying multiple cruise line operating brands"},
                        {"name": "Kyriba Enterprise Treasury Management", "vendor": "Kyriba", "role": "Global multi-currency liquidity forecasting, marine bunker fuel hedging, and FX risk management"},
        ...
        },
        {
            ...
            "variations": {
                "var_salesforce": {
                    "platforms": [
                        {"name": "Workday Human Capital Management (HCM)", "vendor": "Workday", "role": "Core HRIS, talent management, benefits, and global payroll for corporate and shipboard staff"},
                        ...
                        {"name": "Adonis Maritime HR & Crew Planning Suite", "vendor": "Adonis AS", "role": "International maritime labor compliance (MLC 2006 / STCW), crew sign-on/sign-off, and rest-hour logging"}
                    ],
                ...
                "var_no_salesforce": {
                    "platforms": [
                        ...
                        {"name": "UKG Pro (Ultimate Kronos Group)", "vendor": "UKG", "role": "Workforce management, time and attendance, and shift scheduling for terminal and ship staff"},
                        {"name": "SeaChange / Ocean Technologies Group Maritime Crewing", "vendor": "Ocean Technologies Group", "role": "Competence management, e-learning, and maritime regulatory compliance"}
                    ],
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "Workday HCM & Workday Adaptive Planning Enterprise", "vendor": "Workday", "role": "Global human capital management, predictive crew headcount planning, and executive succession"},
                        {"name": "Adonis Enterprise Maritime Suite Sovereign", "vendor": "Adonis AS", "role": "Enterprise-wide crew management, automated flight travel dispatch, and biometric rest-hour logging"},
                        {"name": "UKG InTouch DX Biometric Timeclocks", "vendor": "UKG", "role": "Enterprise facial recognition clock-in for 25,000+ shipboard crew members across the fleet"},
                        {"name": "CyberArk Maritime Privileged Access Management", "vendor": "CyberArk", "role": "Zero-trust privileged identity access for shipboard Chief Engineers and Captains"}
                    ],
        ...
        },
        {
            ...
            "variations": {
                ...
                "var_best_money_can_buy": {
                    "platforms": [
                        {"name": "CyberArk Privileged Access Security Sovereign", "vendor": "CyberArk", "role": "Military-grade credential vaulting and session recording for infrastructure administrators and shipboard systems"},
                        ...
                        {"name": "Zscaler Zero Trust Exchange (ZPA & ZIA)", "vendor": "Zscaler", "role": "Direct-to-cloud zero-trust network access eliminating corporate VPN vulnerabilities for ship-to-shore communications"},
...
json_path = os.path.join(CRUISE_DIR, "data", "tech_stack_data.json")
with open(json_path, "w", encoding="utf-8") as f:
    json.dump(cruises_data, f, indent=2)

# 2. Write tech_stack_data.js
js_path = os.path.join(CRUISE_DIR, "data", "tech_stack_data.js")
with open(js_path, "w", encoding="utf-8") as f:
    f.write("const CRUISES_TECH_STACK_DATA = " + json.dumps(cruises_data, indent=2) + ";\n")

# 3. Render HTML and Markdown via shared stack_renderer
stack_renderer.render_html(cruises_data, "CRUISES_TECH_STACK_DATA", "data/tech_stack_data.js", os.path.join(CRUISE_DIR, "tech_stack.html"))
stack_renderer.render_markdown(cruises_data, os.path.join(CRUISE_DIR, "ENTERPRISE_TECH_STACK_ARCHITECTURE_COMPENDIUM.md"))

print("Cruises tech stack generation completed successfully.")
